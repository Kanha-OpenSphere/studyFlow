...
const Register = () => {
  ...
  return (
     <div className='w-full flex flex-col items-center px-[20px]'>
        ...
        <h4 className="md:text-[32px] text-[24px] w-full text-center mb-[20px]">Wellcome brother!</h4>
        <div className="form w-full flex flex-col gap-[22px]">
          ...
          <div className="input flex flex-col gpa-[8px] w-full">
            ...
            <button className='bg-secondary text-black py-[5px] rounded-[8px] w-full mt-[30px] cursor-pointer'>REGISTER</button>
            ...
            <div>
              <span className='text-[13px] font-light font-mono text-[#a7a7a7]'>already have an account |<span className='text-secondary cursor-pointer' onClick={() => navigate('/auth/login')}>Sign In!</span></span>
            </div>
        </div>
  )
}
